...
class Dezo_Tools {
	 ...
	 *
	 * - Dezo_Tools_Loader. Orchestrates the hooks of the plugin.
	 * - Dezo_Tools_i18n. Defines internationalization functionality.
	 * - Dezo_Tools_Admin. Defines all hooks for the admin area.
	 * - Dezo_Tools_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dezo-tools-loader.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new Dezo_Tools_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Dezo_Tools_Public( $this->get_plugin_name(), $this->get_version() );
